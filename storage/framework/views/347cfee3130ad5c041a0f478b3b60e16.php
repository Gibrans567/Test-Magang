        ...
        <div class="my-3 p-3 bg-body rounded shadow-sm">
            ...
            <form action='' method='post'>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="date" class="form-control w-50" name='tanggal_publikasi' id="tanggal_publikasi" value="<?php echo e(isset($data['tanggal_publikasi'])?$data['tanggal_publikasi']:old('tanggal_publikasi')); ?>">
                    </div>
                </div>
                <div class="mb-3 row">
...
<?php if(Route::current()->uri == 'buku'): ?>
        ...
        <div class="my-3 p-3 bg-body rounded shadow-sm">
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo e(date('d/m/Y',strtotime($item['tanggal_publikasi']))); ?></td>
                        <td>
                            <a href="<?php echo e(url('buku/'.$item['id'])); ?>" class="btn btn-warning btn-sm">Edit</a>
                            <form action="<?php echo e(url('buku/'.$item['id'])); ?>" method="post" onsubmit="return confirm('Apakah Yakin akan melakukan penghapusan data')" class="d-inline">
                                <?php echo csrf_field(); ?>
            ...
            <nav aria-label="Page navigation example">
                <ul class="pagination">
                    <?php $__currentLoopData = $data['links']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="page-item <?php echo e($item['active']? 'active':''); ?>"><a class="page-link" href="<?php echo e($item['url2']); ?>"><?php echo $item['label']; ?></a></li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </ul>
              </nav>
              <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\laravel\resources\views/buku/index.blade.php ENDPATH**/ ?>